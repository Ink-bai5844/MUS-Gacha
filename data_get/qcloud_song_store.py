...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--db", default="data/qcloud_songs.sqlite3", help="SQLite output path.")
    parser.add_argument("--json-dir", default="data/qcloud_song_json", help="Per-song JSON output dir.")
